...
class CORSRequestHandler(SimpleHTTPRequestHandler):
    ...
    def handle_notion_proxy(self):
        try:
            ...
            # 필터 데이터 준비 (DB별 구분)
            massage_db_ids = ['203e5f74c72e815d8f39d2946ee85c0a', '203e5f74-c72e-815d-8f39-d2946ee85c0a', '203e5f74c72e815d8f39d2946ee85c0']
            poolvilla_db_ids = ['208e5f74c72e805f9f29da2780d34974', '208e5f74-c72e-805f-9f29-da2780d34974']
...
if __name__ == '__main__':
    ...
    print("🔗 풀빌라 전체: http://localhost:8080/modules/poolvilla/poolvilla-section.html")
    print("🔗 풀빌라 상세: http://localhost:8080/modules/poolvilla/poolvilla-section.html?id=1")    
    print("🔗 홈페이지: http://localhost:8080/index.html")
    print("🔗 홈페이지: http://localhost:8080/index.html")
    print("🔗 홈페이지: http://localhost:8080/index.html")
    print("🔗 홈페이지: http://localhost:8080/index.html")
